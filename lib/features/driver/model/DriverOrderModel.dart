...
DriverOrderModel driverOrderModelFromJson(String str) => DriverOrderModel.fromJson(json.decode(str));

String driverOrderModelToJson(DriverOrderModel data) => json.encode(data.toJson());
