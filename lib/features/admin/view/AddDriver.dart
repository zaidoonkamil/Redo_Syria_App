...
class _DriverAddDriverForm extends StatelessWidget {
  final LoginCubit cubit;
  final LoginStates state;

  const _DriverAddDriverForm({required this.cubit, required this.state});
          ...
          child: Column(
            children: [
              ...
              CustomTextField(
                ...
                controller: AddDriver.driverNameController,
                validate: (v) => (v == null || v.isEmpty) ? 'رجائاً ادخل الاسم الثلاثي' : null,
              ),
              const SizedBox(height: 10),

              CustomTextField(
                controller: AddDriver.driverPhoneController,
                hintText: 'رقم الهاتف',
              ...
              CustomTextField(
                controller: AddDriver.driverLocationController,
              ...
              const SizedBox(height: 10),
              CustomTextField(
                controller: AddDriver.vehicleTypeController,
              ...
              CustomTextField(
                controller: AddDriver.vehicleColorController,
              ...
              CustomTextField(
                controller: AddDriver.vehicleNumberController,
              ...
              CustomTextField(
                controller: AddDriver.driverPasswordController,
                hintText: 'كلمة السر',
              ...
              CustomTextField(
                controller: AddDriver.driverRePasswordController,
              ...
              ConditionalBuilder(
                ...
                builder: (_) => CustomButton(
                  ...
                  onPressed: () {
                    if (AddDriver.driverFormKey.currentState!.validate()) {
                      if (AddDriver.driverPasswordController.text != AddDriver.driverRePasswordController.text) {
                        showSnackBarError(text: "كلمة السر غير متطابقة", context: context);
                        return;
                      }

                      cubit.signUpDriver(
                        name: AddDriver.driverNameController.text.trim(),
                        phone: AddDriver.driverPhoneController.text.trim(),
                        location: AddDriver.driverLocationController.text.trim(),
                        password: AddDriver.driverPasswordController.text.trim(),
                        context: context,
                        status: 'active',
                        vehicleType: AddDriver.vehicleTypeController.text.trim(),
                        vehicleColor: AddDriver.vehicleColorController.text.trim(),
                        vehicleNumber: AddDriver.vehicleNumberController.text.trim(),
                      );
                    }
