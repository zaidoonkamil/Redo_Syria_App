...
class _AdminUsersState extends State<Drivers> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => AppCubitAdmin()..getDriverOnly(context: context, page: "1"),
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: _searchController.text.isEmpty
                          ...
                          onPressed: () {
                            ...
                            setState(() => _page = 1);
                            cubit.getDriverOnly(context: context, page: "1"); // رجع القائمة الطبيعية
                          },
                        ),
                      ...
                      onChanged: (val) {
                        ...
                        _debounce = Timer(const Duration(milliseconds: 450), () {
                          ...
                          if (q.isEmpty) {
                            ...
                            cubit.searchDriversOnly(context: context, q: q, page: "1");
                          }
                        });
                      },
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: _PaginationBar(
                              ...
                              onPage: (p) {
                                setState(() => _page = p);
                                cubit.getDriverOnly(context: context, page: p.toString());
                              },
                            ),
                          ),
                        ],
                ...
                children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              navigateTo(context, DriverOrder(driverId: d.id.toString()));
                            },
                            child: Container(
                              padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(999),
                                border: Border.all(color: secondPrimaryColor.withOpacity(0.25)),
                              ),
                              child: Text(
                                "الطلبات",
                                style: TextStyle(color: secondPrimaryColor, fontWeight: FontWeight.bold, fontSize: 12),
                              ),
                            ),
                          ),
                        ],
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                "حذف المستخدم",
                                style: TextStyle(color: Colors.redAccent.shade700, fontWeight: FontWeight.bold, fontSize: 12),
                              ),
                            ),
                          ),
                  ...
                  Column(
                    children: [
                      ...
                      Icon(open ? Iconsax.arrow_up_2 : Iconsax.arrow_down_1, color: Colors.grey, size: 18),
                    ],
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      _InfoPill(title: "Debt Blocked", value: d.isDebtBlocked ? "نعم" : "لا"),
                    ],
                  ),
                  ...
                  const SizedBox(height: 10),
                  CustomButton(title: 'الطلبات', onPressed: (){
                    navigateTo(context, DriverOrder(driverId: d.id.toString()));
                  }),
                  const SizedBox(height: 10),
                  InkWell(
                    onTap: () => _showWalletTopUpDialog(context, d.id.toString()),
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Iconsax.money_send, color: Colors.green.shade700, size: 18),
                          const SizedBox(width: 8),
                          Text(
                            "شحن رصيد",
                  ...
                  const SizedBox(height: 10),
                  _InfoLine(icon: Iconsax.location, title: "الموقع", value: d.location),
                  ...
                  Wrap(
                    ...
                    alignment: WrapAlignment.end,
                    children: [
                      _ImageMiniCard(title: "صورة السائق", fileName: d.driverImage.main),
                      _ImageMiniCard(title: "صورة السيارة", fileName: d.carImages.main),
                      _ImageMiniCard(title: "اجازة أمام", fileName: d.drivingLicenseFront.main),
                      _ImageMiniCard(title: "اجازة خلف", fileName: d.drivingLicenseBack.main),
                    ],
                  ),
                ],
              ),
              ...
              try {
                ...
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('تم شحن محفظة الكابتن بمبلغ $amount IQD'),
